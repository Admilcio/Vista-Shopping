                              ...
                              <div class="col-lg-2">
                                  <div class="details-image-vertical black-slide rounded">
                                      ...
                                      @endphp
                                        ...
                                        <div>
                                            <img src="{{('/assets/images/fashion/product/front')}}/{{$image}}"
                                  ...
                                  <div class="details-image-1 ratio_asos">
                                      <div>
                                          <img src="{{('/assets/images/fashion/product/front')}}/{{$product->image}}"
                                              ...
                                              class="img-fluid w-100 image_zoom_cls-0  lazyload" alt="{{$product->name}}">
                                      </div>
                                      ...
                                      @endphp
                                        ...
                                        <div>
                                            <img src="{{('/assets/images/fashion/product/front')}}/{{$product->image}}"
                                                class="img-fluid w-100 image_zoom_cls-1  lazyload" alt="">
                                        </div>
                                        @endforeach
                                      @endif
                      ...
                      <div class="col-md-6">
                          <div class="cloth-details-size">
                              ...
                              <ul class="product-count shipping-order">
                                  <li>
                                      <img src="../assets/images/gif/truck.png" class="img-fluid lazyload"
                                          alt="image">
                                  ...
                                  <div class="font-light timer-5">
                                      ...
                                      <ul class="timer1">
                                          <li class="counter">
                                            ...
                                            @endphp
                                              <h5 id="days">{{-- &#9251; --}} {{$interval->d}}</h5> Days :
                                             
                                                
                                          </li>
                                          <li class="counter">
                                              <h5 id="hours">{{-- &#9251; --}}{{$interval->h}}</h5> Hour :
                                                
                                          </li>
                                          <li class="counter">
                                              <h5 id="minutes">{{-- &#9251; --}}  {{$interval->i}}</h5> Min :
                                               
                                          </li>
                                          <li class="counter">
                                              <h5 id="seconds">{{-- &#9251; --}} {{$interval->s}}</h5> Sec
              ...
              <div  class="row g-sm-4 g-3 row-cols-lg-4 row-cols-md-3 row-cols-2 mt-1 custom-gy-5 product-style-2 ratio_asos product-list-section">
                @foreach($rproducts as $rproduct)
                  <div>
                   ...
                   {{--            <div class="back">
                                  <a href="{{route('shop.product.details', ['slug'=>$rproduct->slug])}}">
                                      <img src="{{route('assets/images/fashion/product/front')}}/{{$rproduct->image}}"
                                          class="bg-img lazyload" alt="">
                                  </a>
                              </div> --}}
                              <div class="cart-wrap">
                          ...
                          <div class="product-details">
                              ...
                              <div class="main-price">
                                  ...
                                  @if($rproduct->sale_price)
                                     <h3 class="theme-color">{{$rproduct->sale_price}}</h3>
                                @else
                                    <h3 class="theme-color">          {{$rproduct->regular_price}}</h3>
                                @endif
